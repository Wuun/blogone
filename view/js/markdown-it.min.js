        ...
        return function e(r, t, n) {
            ...
            6: [function(e, r, t) {
                ...
                r.exports = function(e, r, t) {
                    ...
                    if (60 === e.charCodeAt(r)) {
                        for (r++; r < t; ) {
                            if (10 === (s = e.charCodeAt(r)))
                                return a;
                            if (62 === s)
                                return a.pos = r + 1,
                                    a.str = n(e.slice(i + 1, r)),
                                    a.ok = !0,
                                    a;
                            92 === s && r + 1 < t ? r += 2 : r++
                        }
                    ...
                    return i === r ? a : 0 !== o ? a : (a.str = n(e.slice(i, r)),
                        a.lines = 0,
                        a.pos = r,
                        a.ok = !0,
                        a)
            ...
            9: [function(e, r, t) {
                ...
                b.prototype.set = function(e) {
                    return n.assign(this.options, e),
                        this
                }
                    ,
            ...
            12: [function(e, r, t) {
                ...
                function i() {
                    var e;
                    for (this.ruler = new n,
                             e = 0; e < s.length; e++)
                        this.ruler.push(s[e][0], s[e][1]);
                    for (this.ruler2 = new n,
                             e = 0; e < o.length; e++)
                ...
                i.code_inline = function(e, r, t, n, s) {
                    ...
                    i.fence = function(e, r, t, n, i) {
                        ...
                        return h && (f = h.split(/\s+/g)[0]),
                            0 === (a = t.highlight && t.highlight(p.content, f) || o(p.content)).indexOf("<pre") ? a + "\n" : h ? (c = p.attrIndex("class"),
            ...
            18: [function(e, r, t) {
                ...
                r.exports = function(e, r, t, s) {
                    var o, i, a, c, l, u, p, h, f, d, m, _, g, k, b, v, y, C, x, A, w = e.lineMax, D = e.bMarks[r] + e.tShift[r], E = e.eMarks[r];
                    ...
                    for (m = [e.bsCount[r]],
                        ...
                        !((D = e.bMarks[h] + e.tShift[h]) >= (E = e.eMarks[h]))); h++)
            ...
            19: [function(e, r, t) {
                ...
                r.exports = function(e, r, t) {
                    ...
                    return e.line = s,
                        (o = e.push("code_block", "code", 0)).content = e.getLines(r, s, 4 + e.blkIndent, !0),
                        o.map = [r, e.line],
                        !0
                }
            }
            ...
            21: [function(e, r, t) {
                ...
                r.exports = function(e, r, t, s) {
                    ...
                    (a = e.skipCharsBack(u, 35, l)) > l && n(e.src.charCodeAt(a - 1)) && (u = a),
                        ...
                        c.map = [r, e.line],
                        c.children = [],
                        (c = e.push("heading_close", "h" + String(i), -1)).markup = "########".slice(0, i),
                        !0))
                }
            }
                , {
            ...
            25: [function(e, r, t) {
                ...
                function s(e, r) {
                    var t, s, o, i;
                    return s = e.bMarks[r] + e.tShift[r],
                        o = e.eMarks[r],
                        42 !== (t = e.src.charCodeAt(s++)) && 45 !== t && 43 !== t ? -1 : s < o && (i = e.src.charCodeAt(s),
                            !n(i)) ? -1 : s
                }
                function o(e, r) {
                    ...
                    return o < i && (t = e.src.charCodeAt(o),
                        !n(t)) ? -1 : o
                }
                r.exports = function(e, r, t, n) {
                    ...
                    if (e.listIndent >= 0 && e.sCount[r] - e.listIndent >= 4 && e.sCount[r] < e.blkIndent)
                        return !1;
                    if (n && "paragraph" === e.parentType && e.tShift[r] >= e.blkIndent && (I = !0),
                    (q = o(e, r)) >= 0) {
                        if (h = !0,
                    ...
                    if (I && e.skipSpaces(q) >= e.eMarks[r])
                        return !1;
                    if (g = e.src.charCodeAt(q - 1),
                        n)
                        return !0;
                    for (_ = e.tokens.length,
                             h ? (T = e.push("ordered_list_open", "ol", 1),
                             1 !== k && (T.attrs = [["start", k]])) : T = e.push("bullet_list_open", "ul", 1),
                             T.map = m = [r, 0],
                             ...
                             x = e.parentType,
                             e.parentType = "list"; v < t; ) {
                        for (E = q,
                                 b = e.eMarks[v],
                                 p = y = e.sCount[v] + q - (e.bMarks[r] + e.tShift[r]); E < b; ) {
                        ...
                        if ((u = (a = E) >= b ? 1 : y - p) > 4 && (u = 1),
                            ...
                            e.sCount[r] = y,
                            a >= b && e.isEmpty(r + 1) ? e.line = Math.min(e.line + 2, t) : e.md.block.tokenize(e, r, t, !0),
                        e.tight && !F || (R = !1),
                    ...
                    return (T = h ? e.push("ordered_list_close", "ol", -1) : e.push("bullet_list_close", "ul", -1)).markup = String.fromCharCode(g),
                        m[1] = v,
                        e.line = v,
                        e.parentType = x,
                    R && function(e, r) {
            ...
            27: [function(e, r, t) {
                ...
                r.exports = function(e, r, t, o) {
                    var i, a, c, l, u, p, h, f, d, m, _, g, k, b, v, y, C = 0, x = e.bMarks[r] + e.tShift[r], A = e.eMarks[r], w = r + 1;
                    if (e.sCount[r] - e.blkIndent >= 4)
                        return !1;
                    ...
                    for (A = (k = e.getLines(r, w, e.blkIndent, !1).trim()).length,
                             x = 1; x < A; x++) {
                        if (91 === (i = k.charCodeAt(x)))
                            return !1;
                        if (93 === i) {
                            d = x;
                            break
                    ...
                    if (d < 0 || 58 !== k.charCodeAt(d + 1))
                        return !1;
                    for (x = d + 2; x < A; x++)
                        if (10 === (i = k.charCodeAt(x)))
                            C++;
                        else if (!s(i))
                            break;
                    if (!(_ = e.md.helpers.parseLinkDestination(k, x, A)).ok)
                        return !1;
                    ...
                    for (a = x = _.pos,
                        ...
                        if (10 === (i = k.charCodeAt(x)))
                            ...
                            break;
                    for (_ = e.md.helpers.parseLinkTitle(k, x, A),
                             x < A && g !== x && _.ok ? (y = _.str,
                                 x = _.pos,
                                 C += _.lines) : (y = "",
                                 x = a,
                                 C = c); x < A && (i = k.charCodeAt(x),
                        s(i)); )
                        x++;
                    if (x < A && 10 !== k.charCodeAt(x) && y)
                        for (y = "",
                            ...
                            s(i)); )
                            x++;
                    return !(x < A && 10 !== k.charCodeAt(x)) && (!!(f = n(k.slice(1, d))) && (!!o || (void 0 === e.env.references && (e.env.references = {}),
            ...
            29: [function(e, r, t) {
                ...
                r.exports = function(e, r, t, i) {
                    ...
                    if (124 !== (a = e.src.charCodeAt(l++)) && 45 !== a && 58 !== a)
                        return !1;
                    for (; l < e.eMarks[p]; ) {
                        if (124 !== (a = e.src.charCodeAt(l)) && 45 !== a && 58 !== a && !n(a))
                            return !1;
                        l++
                    }
                    for (h = (c = s(e, r + 1)).split("|"),
                             m = [],
                             u = 0; u < h.length; u++) {
                        if (!(_ = h[u].trim())) {
                            if (0 === u || u === h.length - 1)
                    ...
                    for (d = e.push("tr_close", "tr", -1),
                             ...
                             p = r + 2; p < t && !(e.sCount[p] < e.blkIndent) && -1 !== (c = s(e, p).trim()).indexOf("|") && !(e.sCount[p] - e.blkIndent >= 4); p++) {
                        for (h = o(c.replace(/^\||\|$/g, "")),
                    ...
                    if (e.md.options.linkify)
                        for (t = 0,
                            ...
                            if ("inline" === y[t].type && e.md.linkify.pretest(y[t].content))
                                for (m = 0,
                                         r = (i = y[t].children).length - 1; r >= 0; r--)
                                    if ("link_close" !== (c = i[r]).type) {
                                        if ("html_inline" === c.type && (v = c.content,
                                        /^<a[>\s]/i.test(v) && m > 0 && m--,
                                        s(c.content) && m++),
                                        !(m > 0) && "text" === c.type && e.md.linkify.test(c.content)) {
                                            for (p = c.content,
                                                ...
                                                e.md.validateLink(g) && (k = b[u].text,
                                                    k = b[u].schema ? "mailto:" !== b[u].schema || /^mailto:/i.test(k) ? e.md.normalizeLinkText(k) : e.md.normalizeLinkText("mailto:" + k).replace(/^mailto:/, "") : e.md.normalizeLinkText("http://" + k).replace(/^http:\/\//, ""),
                                                (h = b[u].index) > f && ((a = new e.Token("text","",0)).content = p.slice(f, h),
                                                    a.level = d,
                                                    l.push(a)),
                                                    ...
                                                    l.push(a),
                                                    f = b[u].lastIndex);
                                            f < p.length && ((a = new e.Token("text","",0)).content = p.slice(f),
                                                a.level = d,
                                                l.push(a)),
                                                y[t].children = i = n(i, r, l)
                                        }
                                    } else
                                        for (r--; i[r].level !== c.level && "link_open" !== i[r].type; )
                                            r--
                }
            }
                , {
            ...
            34: [function(e, r, t) {
                ...
                function l(e) {
                    var r, t, s = 0;
                    for (r = e.length - 1; r >= 0; r--)
                        "text" !== (t = e[r]).type || s || n.test(t.content) && (t.content = t.content.replace(/\+-/g, "\xb1").replace(/\.{2,}/g, "\u2026").replace(/([?!])\u2026/g, "$1..").replace(/([?!]){4,}/g, "$1$1$1").replace(/,{2,}/g, ",").replace(/(^|[^-])---([^-]|$)/gm, "$1\u2014$2").replace(/(^|\s)--(\s|$)/gm, "$1\u2013$2").replace(/(^|[^-\s])--([^-\s]|$)/gm, "$1\u2013$2")),
                ...
                r.exports = function(e) {
                    ...
                    if (e.md.options.typographer)
                        for (r = e.tokens.length - 1; r >= 0; r--)
                            "inline" === e.tokens[r].type && (s.test(e.tokens[r].content) && c(e.tokens[r].children),
            ...
            35: [function(e, r, t) {
                ...
                function u(e, r) {
                    ...
                    for (D = [],
                        ...
                        "text" === i.type) {
                            h = 0,
                                f = (u = i.content).length;
                            e: for (; h < f && (a.lastIndex = h,
                                p = a.exec(u)); ) {
                                if (C = x = !0,
                                    h = p.index + 1,
                                    w = "'" === p[0],
                                ...
                                if (k = o(_) || s(String.fromCharCode(_)),
                                    b = o(g) || s(String.fromCharCode(g)),
                                    v = n(_),
                                    (y = n(g)) ? C = !1 : b && (v || k || (C = !1)),
                                    v ? x = !1 : k && (y || b || (x = !1)),
                                34 === g && '"' === p[0] && _ >= 48 && _ <= 57 && (x = C = !1),
                                C && x && (C = !1,
                                    x = b),
                                C || x) {
                                    if (x)
                                        for (A = D.length - 1; A >= 0 && (m = D[A],
                                            ...
                                            if (m.single === w && D[A].level === d) {
                                                m = D[A],
                                                    ...
                                                    i.content = l(i.content, p.index, q),
                                                    e[m.token].content = l(e[m.token].content, m.pos, E),
                                                    h += q.length - 1,
                                    ...
                                    w && (i.content = l(i.content, p.index, c))
                            }
                        }
                    }
                }
                r.exports = function(e) {
                    ...
                    if (e.md.options.typographer)
                        for (r = e.tokens.length - 1; r >= 0; r--)
                            "inline" === e.tokens[r].type && i.test(e.tokens[r].content) && u(e.tokens[r].children, e)
                }
            }
                , {
                    "../common/utils": 4
            ...
            37: [function(e, r, t) {
                ...
                r.exports = function(e, r) {
                    ...
                    return 60 === e.src.charCodeAt(u) && (!((t = e.src.slice(u)).indexOf(">") < 0) && (s.test(t) ? (a = (o = t.match(s))[0].slice(1, -1),
                    ...
                    !!e.md.validateLink(c) && (r || ((l = e.push("link_open", "a", 1)).attrs = [["href", c]],
                        ...
                        l.info = "auto"),
                        e.pos += o[0].length,
                        !0)) : !!n.test(t) && (a = (i = t.match(n))[0].slice(1, -1),
            ...
            39: [function(e, r, t) {
                ...
                function n(e, r) {
                    ...
                    for (t = 0; t < p; t++)
                        if ((s = r[t]).length = s.length || 0,
                            s.close) {
                            for (u.hasOwnProperty(s.marker) || (u[s.marker] = [-1, -1, -1]),
                                     i = u[s.marker][s.length % 3],
                                     a = -1,
                                     n = t - s.jump - 1; n > i; n -= o.jump + 1)
                                if ((o = r[n]).marker === s.marker && (-1 === a && (a = n),
                                o.open && o.end < 0 && o.level === s.level && (c = !1,
                ...
                function n(e, r) {
                    ...
                    for (t = r.length - 1; t >= 0; t--)
                        95 !== (n = r[t]).marker && 42 !== n.marker || -1 !== n.end && (s = r[n.end],
                            a = t > 0 && r[t - 1].end === n.end + 1 && r[t - 1].token === n.token - 1 && r[n.end + 1].token === s.token + 1 && r[t - 1].marker === n.marker,
            ...
            43: [function(e, r, t) {
                ...
                r.exports = function(e, r) {
                    ...
                    !(60 !== e.src.charCodeAt(i) || i + 2 >= o) && (!(33 !== (t = e.src.charCodeAt(i + 1)) && 63 !== t && 47 !== t && !function(e) {
                        var r = 32 | e;
                        return r >= 97 && r <= 122
                    }(t)) && (!!(s = e.src.slice(i).match(n)) && (r || (e.push("html_inline", "", 0).content = e.src.slice(i, i + s[0].length)),
                        e.pos += s[0].length,
                        !0))))
                }
            }
            ...
            44: [function(e, r, t) {
                ...
                r.exports = function(e, r) {
                    ...
                    if ((u = c + 1) < b && 40 === e.src.charCodeAt(u)) {
                        for (u++; u < b && (o = e.src.charCodeAt(u),
                        s(o) || 10 === o); u++)
                            ;
                        if (u >= b)
                            return !1;
                        for (_ = u,
                             (h = e.md.helpers.parseLinkDestination(e.src, u, e.posMax)).ok && (g = e.md.normalizeLink(h.str),
                                 ...
                                 _ = u; u < b && (o = e.src.charCodeAt(u),
                        s(o) || 10 === o); u++)
                            ;
                        if (h = e.md.helpers.parseLinkTitle(e.src, u, e.posMax),
                        u < b && _ !== u && h.ok)
                            for (f = h.str,
                                     u = h.pos; u < b && (o = e.src.charCodeAt(u),
                            s(o) || 10 === o); u++)
                                ;
                        else
                            f = "";
                        if (u >= b || 41 !== e.src.charCodeAt(u))
                            return e.pos = k,
                                !1;
                        u++
                    } else {
                        if (void 0 === e.env.references)
                            return !1;
                        if (u < b && 91 === e.src.charCodeAt(u) ? (_ = u + 1,
            ...
            53: [function(e, r, t) {
                ...
                function p(r) {
                                ...
                                if (null !== t) {
                                    ...
                                    "[object Object]" === s(t))
                                        return !function(e) {
                                            ...
                                            void (o(t.normalize) ? n.normalize = t.normalize : t.normalize ? u(e, t) : n.normalize = function(e, r) {
                                                    r.normalize(e)
                                                }
                                            );
                                    !function(e) {
                    ...
                    r.re.schema_test = RegExp("(^|(?!_)(?:[><\uff5c]|" + t.src_ZPCc + "))(" + p + ")", "i"),
                        r.re.schema_search = RegExp("(^|(?!_)(?:[><\uff5c]|" + t.src_ZPCc + "))(" + p + ")", "ig"),
                ...
                d.prototype.add = function(e, r) {
                    ...
                    d.prototype.match = function(e) {
                        var r = 0
                            , t = [];
                        this.__index__ >= 0 && this.__text_cache__ === e && (t.push(f(this, r)),
            ...
            54: [function(e, r, t) {
                ...
                r.exports = function(r) {
                    ...
                    return t.src_pseudo_letter = "(?:(?![><\uff5c]|" + t.src_ZPCc + ")" + t.src_Any + ")",
                        ...
                        t.src_path = "(?:[/?#](?:(?!" + t.src_ZCc + "|[><\uff5c]|[()[\\]{}.,\"'?!\\-]).|\\[(?:(?!" + t.src_ZCc + "|\\]).)*\\]|\\((?:(?!" + t.src_ZCc + "|[)]).)*\\)|\\{(?:(?!" + t.src_ZCc + '|[}]).)*\\}|\\"(?:(?!' + t.src_ZCc + '|["]).)+\\"|\\\'(?:(?!' + t.src_ZCc + "|[']).)+\\'|\\'(?=" + t.src_pseudo_letter + "|[-]).|\\.{2,4}[a-zA-Z0-9%/]|\\.(?!" + t.src_ZCc + "|[.]).|" + (r && r["---"] ? "\\-(?!--(?:[^-]|$))(?:-*)|" : "\\-+|") + "\\,(?!" + t.src_ZCc + ").|\\!(?!" + t.src_ZCc + "|[!]).|\\?(?!" + t.src_ZCc + "|[?]).)+|\\/)?",
            ...
            59: [function(e, r, t) {
                ...
                n.prototype.parse = function(e, r) {
                    ...
                    if (g && (o = (g = g[0]).toLowerCase(),
                        this.protocol = g,
                        m = m.substr(g.length)),
                    (r || g || m.match(/^\/\/[^@\/]+@[^@\/]+/)) && (!(c = "//" === m.substr(0, 2)) || g && f[g] || (m = m.substr(2),
                        this.slashes = !0)),
                    !f[g] && (c || g && !d[g])) {
                        var k, b, v = -1;
                        for (t = 0; t < u.length; t++)
                            -1 !== (a = m.indexOf(u[t])) && (-1 === v || a < v) && (v = a);
                        for (-1 !== (b = -1 === v ? m.lastIndexOf("@") : m.lastIndexOf("@", v)) && (k = m.slice(0, b),
                            m = m.slice(b + 1),
                            this.auth = k),
                                 v = -1,
                                 t = 0; t < l.length; t++)
                    ...
                    var L = m.indexOf("#");
                    -1 !== L && (this.hash = m.substr(L),
                        m = m.slice(0, L));
                    var z = m.indexOf("?");
                    return -1 !== z && (this.search = m.substr(z),
                        m = m.slice(0, z)),
                    m && (this.pathname = m),
            ...
            60: [function(e, r, t) {
                (function(e) {
                        !function(n) {
                            ...
                            var a, c, l = 2147483647, u = 36, p = 1, h = 26, f = 38, d = 700, m = 72, _ = 128, g = "-", k = /^xn--/, b = /[^\x20-\x7E]/, v = /[\x2E\u3002\uFF0E\uFF61]/g, y = {
                            ...
                            function E(e, r) {
                                ...
                                return t.length > 1 && (n = t[0] + "@",
                                    e = t[1]),
                                n + D((e = e.replace(v, ".")).split("."), r).join(".")
                            }
                            function q(e) {
                            ...
                            function F(e) {
                                return D(e, (function(e) {
                                        var r = "";
                                        return e > 65535 && (r += A((e -= 65536) >>> 10 & 1023 | 55296),
                                            e = 56320 | 1023 & e),
                                            r += A(e)
                                    }
                                )).join("")
                            ...
                            function z(e) {
                                ...
                                for (s = t > 0 ? t + 1 : 0; s < v; ) {
                                    for (o = y,
                                             i = 1,
                                             a = u; s >= v && w("invalid-input"),
                                         ((c = (k = e.charCodeAt(s++)) - 48 < 10 ? k - 22 : k - 65 < 26 ? k - 65 : k - 97 < 26 ? k - 97 : u) >= u || c > x((l - y) / i)) && w("overflow"),
                                             y += c * i,
                                             !(c < (f = a <= A ? p : a >= A + h ? h : a - A)); a += u)
                                        i > x(l / (d = u - f)) && w("overflow"),
                                            i *= d;
                                    A = L(y - o, r = b.length + 1, 0 == o),
                                    x(y / r) > l - C && w("overflow"),
                                        C += x(y / r),
                                        y %= r,
                                        b.splice(y++, 0, C)
                                }
                            ...
                            function T(e) {
                                ...
                                for (b = (e = q(e)).length,
                                         ...
                                         o = m,
                                         i = 0; i < b; ++i)
                                    (k = e[i]) < 128 && D.push(A(k));
                                for (n = s = D.length,
                                     s && D.push(g); n < b; ) {
                                    for (a = l,
                                             i = 0; i < b; ++i)
                                        (k = e[i]) >= r && k < a && (a = k);
                                    for (a - r > x((l - t) / (v = n + 1)) && w("overflow"),
                                             t += (a - r) * v,
                                             r = a,
                                             i = 0; i < b; ++i)
                                        if ((k = e[i]) < r && ++t > l && w("overflow"),
                                        k == r) {
                                            for (c = t,
                                                     f = u; !(c < (d = f <= o ? p : f >= o + h ? h : f - o)); f += u)
                                                C = c - d,
                                                    y = u - d,
                                                    D.push(A(S(d + C % y, 0))),
                                                    c = x(C / y);
